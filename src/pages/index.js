                    ...
                    <Container>
                        <Row>
                            <Col md={8}>
                                ...
                                <br/>
                                <br/>
                                <Button variant="success" href='#why'>Get a hold of your data-driven research →</Button>
                            </Col>
                        </Row>
                    </Container>
                </div>
                                    ...
                                    <Col lg={6} md={12} sm={12} style={{padding: '10px'}}>
                                        <Card className={styles.cardhover}>
                                            <Card.Body>
                                                ...
                                                <Card.Text>
                                                    &apos;No one knows if the market will go up down left right&apos; is
                                                    a
                                                    complete lie.
                                                    ...
                                                    data-driven
                                                    graphics so that you can make the investing decisions you have
                                                    always
                                                    dreamed
                                                    of.
                                                </Card.Text>
                                    ...
                                    <Col lg={6} md={12} sm={12} style={{padding: '10px'}}>
                                        <Card className={styles.cardhover}>
                                            <Card.Body>
                                                ...
                                                <Card.Text>
                                                    Markets move together most of the time, but being able to identify
                                                    when
                                                    they
                                    ...
                                    <Col lg={6} md={12} sm={12} style={{padding: '10px'}}>
                                        <Card className={styles.cardhover}>
                                            <Card.Body>
                                                ...
                                                <Card.Text>
                                                    Here at Webminers we offer three plans to fit your specific needs.
                                                    Whether
                                                    you just want the seasons, need to balance our your portfolio with
                                                    more
                                            ...
                                            <Card className={styles.cardhover}>
                                                <Card.Body>
                                                    ...
                                                    <Card.Text style={{textAlign: 'center', padding: '5px'}}>
                                                        Everything is very easy to understand and read. I love how the
                                                        findings
                                                        are
                                                        backed by data and science! I think the research section is the
                                                        best
                                                        part
                                                        where
                                        ...
                                        <Col md={12} lg={4} style={{padding: '15px'}}>
                                            <Card className={styles.cardhover}>
                                                <Card.Body>
                                                    ...
                                                    <Card.Text style={{textAlign: 'center', padding: '5px'}}>
                                                        Market and Asset Seasons are a great help in understanding where
                                                        the
                                                        market
                                                        is
                                                        and for what. I love that inflation is taken into account so I
                                                        know
                                                        how
                                                        well
                                                        the
                                        ...
                                        <Col md={12} lg={4}>
                                            <Card className={styles.cardhover}>
                                                <Card.Body>
                                                    ...
                                                    <Card.Text style={{textAlign: 'center', padding: '5px'}}>
                                                        Super Accurate Seasons and Balancing. I check the daily updates
                                                        before
                                                        doing
                                                        anything in the markets to make sure what I&apos;m doing is a
                                                        smart
                                                        decision.
                                        ...
                                        <Row>
                                            <Col lg={6} md={6} sm={12} style={{padding: '10px'}}>
                                                <Card style={{backgroundColor: 'rgba(0,0,0,0)'}}>
                                                    <Card.Body>
                                                        <Card.Text>
                                                            Take a look at our articles you will find interesting
                                                            topics,
                                                            updates, and even just content about webminers like our
                                                            history
