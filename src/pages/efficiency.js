...
const BASE_YEAR = 1984 // base year for CPI data
const API_URL = `https://api.bls.gov/publicAPI/v2/timeseries/data/CUUR0000SA0?startYear=${BASE_YEAR}&endYear=${new Date().getFullYear()}&registrationkey=[YOUR_API_KEY]` // replace [YOUR_API_KEY] with your BLS API key
                    ...
                    <Col xxl={2} lg={12}>
                        <div>
                            ...
                            <Col>
                                ...
                                <Row style={{margin: '15px'}}>
                                    <label style={{padding: 0}} htmlFor="time">{timeUnit} till Goal</label>
                                ...
                                <Row style={{margin: '15px'}}>
                                    ...
                                    <input className={styles.inputs} step="0.01" value={totalProfit} type="text" id="result" disabled/>
                                </Row>
                            </Col>
                        </div>
                    </Col>
