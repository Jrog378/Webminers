...
export default function StandOut() {
    const Artsections = [
    {
        ...
        text: 'The world of developers and programmers is a plentiful place. There are tons of people with the ' +
            ...
            'world:\n' +
            '1. Show that you do more than sit at home and code.\n' +
            '2. Show your projects mean something to you\n' +
            '3. Grow your network\n' +
            '4. Reach out instead of just applying online\n' +
            '5. Show you can learn new things'
    },
    {
        img: Unique1,
                    ...
                    <header>
                        <Card style={{borderStyle: 'none', background: 'none'}}>
                            <Card.Title style={{
                                ...
                                Avoid the copy and paste psyche & break applicant uniformity
                            </Card.Title>
