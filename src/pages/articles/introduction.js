    ...
    const Article = [
        {
            ...
            text: 'As a professional in the crypto scene, I could never have predicted this from such a unique past. I have always dreamed of owning my business and started college in engineering. After analyzing the programs in the engineering department, I realized it wasn’t for me. Even though I enjoyed repairing vehicles and machines, I did not feel the passion I hoped for.\n' +
                '\n' +
                'I fell into the Data Science major that my college offered. Computer science was on the table, but I needed a passion for the classes. Data Science felt right to me, and I had already taken one of their classes before making the swap.\n' +
                '\n' +
                'I started engulfing myself in data, learning data mining and visualization. I took online classes and worked on extra projects. I researched the jobs and fields I could go into. I was hooked and could not get enough data. I used Kaggle for datasets and knew that if I wanted to be a professional in the field, my work would have to be similar to those competing in coding competitions, but everything looked so complicated.\n'
        },
        {
            ...
            text: 'I wanted to start a business on top of my schooling, so I began coding to learn how to create websites enough to start selling my services. I built my personal project and worked hard to style it and make it as professional as possible. After I felt I had worked enough, I thought about how much work I did for a single website and that I wanted to do something other than that for every customer I had. The website I was creating took a lot of effort and specialization, and I knew it was only authentic to me. I felt like I only wanted to develop for myself.\n' +
                '\n' +
                'I needed that unique idea to get me into the life I wanted to live by owning my business. It was summer. I spend time working on my car or doing projects around the house, working with my hands back to my engineer routes. I decided to attempt a new type of service. I started to research what I could do, finding little things like Data Visualization, Data Storytelling, Data Mining, or even Web Scraping, waiting for the opportunity good enough to start a business.\n' +
                '\n' +
        ...
        },
        {
            ...
            text: 'Once again, the programming side of things did not stick with me. I loved programming and could do it all day as long as I had a purpose. I just had this feeling deep down that programming for others isn\'t my thing. I dropped the idea again. Thinking back, I am grateful for these trials because learning what works for me and what does not, even though it might have seemed like a waste of time, has all come back to help me later on.\n' +
                ...
                '\n' +
                'What to do crowded my mind. Summer was running out, and now was the best time to focus my mind on something and jump-start a business before school began again. I had been a minor participant in the Crypto markets with [Coinbase] and their free coins for learning about the company. This time was different. I wanted to use my data science knowledge in the markets.\n'
        },
        {
            title: 'Next Steps',
            img: Intro3,
